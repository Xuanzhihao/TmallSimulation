...
import com.tmall.tmall_springboot.service.ProductImageService;
import com.tmall.tmall_springboot.service.ProductService;
import com.tmall.tmall_springboot.util.ImageUtil;
...
public class ProductImageController {
    ...
    public Object add(@RequestParam("pid") int pid, @RequestParam("type") String type, MultipartFile image, HttpServletRequest request) throws Exception{
        ...
        File imageFloder = new File(request.getServletContext().getRealPath(folder));
